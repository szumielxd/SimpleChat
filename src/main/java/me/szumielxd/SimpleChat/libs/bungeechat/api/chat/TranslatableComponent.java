...
import me.szumielxd.SimpleChat.libs.bungeechat.chat.TranslationRegistry;
...
extends BaseComponent {
		...
		while (matcher.find(position)) {
			...
			switch (formatCode.charAt(0)) {
				...
				case 's': {
					...
					BaseComponent withComponent = this.with.get(withIndex != null ? Integer.parseInt(withIndex) - 1 : i2++);
					if (applyFormat) {
	...
	public boolean equals(Object o2) {
		...
		if (!(o2 instanceof TranslatableComponent)) {
			return false;
		}
		TranslatableComponent other = (TranslatableComponent)o2;
